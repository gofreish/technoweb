<x-app-layout>
    ...
    <div class="flex justify-center">
         <div class="bg-slate-200 mt-5 border-2 border-slate-400 rounded-lg p-6 mt-4">
            <div class="text-center text-2xl underline">Ajout de repas</div>
            <form class="mt-4" method="post" action="{{route('repas.store')}}" >
                @csrf
                <div class="border-b border-gray-400 rounded p-2">
                    <label class="text-lg mr-2" for="nom">Nom : </label>
                    <input required class="border-none font-bold italic" placeholder="nom du repas" type="text" name="nom" id="nom">
                </div>
                <div class="mt-2 border-b border-gray-400 rounded p-2">
                    <label class="text-lg mr-2" for="prix">Prix : </label>
                    <input required class="border-none font-bold italic" placeholder="prix du repas" type="number" name="prix" id="prix">
                </div>
                <div class="mt-2  border-b border-gray-400 rounded p-2">
                    <label class="text-lg mr-2" for="nbr_dispo">Nombre de plats : </label>
                    <input required class="border-none font-bold italic" placeholder="Nombre de plats actuellement disponible" type="number" name="nbr_dispo" id="nbr_dispo">
                </div>
